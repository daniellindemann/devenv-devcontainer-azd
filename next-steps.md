...
- [app/Demo.BeerVoting.Backend.bicep](./infra/app/Demo.BeerVoting.Backend.bicep) - Azure Container Apps resources to host the 'Demo.BeerVoting.Backend' service.
- [app/Demo.BeerVoting.Frontend.bicep](./infra/app/Demo.BeerVoting.Frontend.bicep) - Azure Container Apps resources to host the 'Demo.BeerVoting.Frontend' service.
